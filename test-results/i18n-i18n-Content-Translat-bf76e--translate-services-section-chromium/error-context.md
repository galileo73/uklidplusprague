...
- main:
    ...
    - table:
      - rowgroup:
        - row "Apartment Size From":
          ...
          - columnheader "From"
      - rowgroup:
        - row "pricing.categories.standard.items.0.apartment ~35 m² 1,200 CZK":
          - cell "pricing.categories.standard.items.0.apartment"
          - cell "~35 m²"
          - cell "1,200 CZK"
        - row "pricing.categories.standard.items.1.apartment ~45 m² 1,350 CZK":
          - cell "pricing.categories.standard.items.1.apartment"
          - cell "~45 m²"
          - cell "1,350 CZK"
        - row "pricing.categories.standard.items.2.apartment ~55 m² 1,550 CZK":
          - cell "pricing.categories.standard.items.2.apartment"
          - cell "~55 m²"
          - cell "1,550 CZK"
        - row "pricing.categories.standard.items.3.apartment ~65 m² 1,750 CZK":
          - cell "pricing.categories.standard.items.3.apartment"
          - cell "~65 m²"
          - cell "1,750 CZK"
        - row "pricing.categories.standard.items.4.apartment ~75 m² 1,950 CZK":
          - cell "pricing.categories.standard.items.4.apartment"
          - cell "~75 m²"
          - cell "1,950 CZK"
        - row "pricing.categories.standard.items.5.apartment ~85 m² 2,050 CZK":
          - cell "pricing.categories.standard.items.5.apartment"
          - cell "~85 m²"
          - cell "2,050 CZK"
        - row "pricing.categories.standard.items.6.apartment ~95 m² 2,100 CZK":
          - cell "pricing.categories.standard.items.6.apartment"
          - cell "~95 m²"
          - cell "2,100 CZK"
        - row "pricing.categories.standard.items.7.apartment 100+ m² from 2,190 CZK":
          - cell "pricing.categories.standard.items.7.apartment"
          - cell "100+ m²"
          - cell "from 2,190 CZK"
  ...
  - region "Airbnb Host Partner":
    ...
    - list:
      - listitem: airbnb.benefits.turnover.title - airbnb.benefits.turnover.description
      - listitem: airbnb.benefits.express.title - airbnb.benefits.express.description
      - listitem: airbnb.benefits.sameday.title - airbnb.benefits.sameday.description
      - listitem: Key Handling - Key collection and return service available. Flexible access arrangements.
      - listitem: airbnb.benefits.guarantee.title - airbnb.benefits.guarantee.description
      - listitem: airbnb.benefits.priority.title - airbnb.benefits.priority.description
...
- contentinfo:
  ...
  - button "Switch to Čeština": CZ
  - button "Switch to Русский": RU
  - button "Switch to Українська": UA
