...
export function Header({ onMenuToggle, isMenuOpen }: HeaderProps) {
  ...
  return (
    ...
    >
      <nav
        className="container-custom flex items-center justify-between h-20 md:h-24"
        role="navigation"
      ...
      >
        ...
        <a
          href="/"
          className="flex items-center group lg:hidden flex-1 justify-center"
        ...
        >
          ...
          >
            <img
              ...
              className="block h-[60px] md:h-[68px] w-auto max-w-none object-contain shrink-0"
            />

            <span className="block text-2xl md:text-3xl font-bold text-text-primary whitespace-nowrap leading-none shrink-0">
              UKLID PLUS PRAHA
            </span>
          </motion.div>
        </a>
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="lg:hidden p-2 text-text-primary hover:text-accent-primary transition-colors shrink-0"
