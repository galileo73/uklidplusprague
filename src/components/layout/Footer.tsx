...
export function Footer() {
  ...
  return (
    <footer className="bg-dark-secondary border-t border-white/5" role="contentinfo">
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                className="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5 text-text-secondary hover:bg-accent-primary/10 hover:text-accent-primary transition-all"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5 text-text-secondary hover:bg-[#0084FF]/10 hover:text-[#0084FF] transition-all"
                aria-label="Message us on Messenger"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M12 0C5.373 0 0 4.974 0 11.111c0 3.498 1.744 6.614 4.469 8.654V24l4.088-2.242c1.092.301 2.246.464 3.443.464 6.627 0 12-4.975 12-11.111S18.627 0 12 0zm1.175 14.969l-3.074-3.288-6.004 3.288 6.582-6.969 3.15 3.288 5.922-3.288-6.576 6.969z" />
                </svg>
              </a>
            </div>
          </motion.div>
