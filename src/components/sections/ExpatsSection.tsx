...
/**
 * ExpatsSection - Section targeting expats and international professionals
 * Features heading, subheading, checklist of benefits, visual placeholder, and WhatsApp CTA
 * Two-column layout on desktop, single column on mobile
 */
export function ExpatsSection() {
  ...
  return (
    <section
      ...
      aria-labelledby="expats-heading"
    >
      <div className="container-custom px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div variants={headerVariants} className="mb-10">
              <h2
                ...
                dangerouslySetInnerHTML={{ __html: t('expats.heading') }}
              />
                ...
                >
                  ...
                  <div>
                    <span className="text-text-primary font-semibold">
                      {t(`expats.benefits.${benefit.key}.title`)}
                    </span>
                    <span className="text-text-secondary"> - {t(`expats.benefits.${benefit.key}.description`)}</span>
                  </div>
                </motion.li>
              ))}
            </motion.ul>
          ...
          >
            ...
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-gradient-to-br from-dark-secondary via-dark-primary to-dark-secondary">
              {/* Gradient overlay with accent */}
              <div className="absolute inset-0 bg-gradient-to-tr from-accent-primary/10 via-transparent to-accent-primary/5" />
              ...
              {/* Prague apartment illustration placeholder */}
