export default {
  ...
  reviews: {
    ...
    growing: {
      heading: 'Growing Our Reputation',
    },
    cta: {
  ...
  testimonials: {
    ...
    items: {
      ...
      'testimonial-2': {
        quote: 'As an Airbnb host, I need reliable turnover cleaning. UKLID PLUS always delivers - quick response, thorough cleaning, and my guests always comment on how clean the apartment is. Highly recommend!',
        author: 'Michael T.',
      },
      'testimonial-3': {
  ...
  areas: {
    ...
    subheading: 'We serve Prague and surrounding areas',
    note: 'Other areas available on request',
    districts: {
      'prague-1': 'Prague 1',
      'prague-2': 'Prague 2',
      'prague-3': 'Prague 3',
  ...
  contact: {
    ...
    subheading: 'Ready to book your cleaning? Contact us via your preferred channel',
    whatsapp: {
      title: 'WhatsApp',
    ...
    instagram: {
      title: 'Instagram',
      description: 'See our work & reviews',
    },
    area: {
      title: 'Service Area',
      description: 'We serve Prague and surrounding areas',
    },
    languages: {
      title: 'Languages',
      list: 'English, Czech, Russian, Ukrainian',
    },
    form: {
  ...
  footer: {
    ...
    tagline: 'Professional cleaning services for expats in Prague',
  },
  ...
  privacy: {
    ...
    intro: 'UKLID PLUS PRAHA respects your privacy and is committed to protecting your personal data.',
    sections: {
      dataCollection: {
      ...
      dataUsage: {
        ...
        items: [
          ...
          'Maintain service history for quality assurance',
        ],
      },
      dataSharing: {
        ...
        items: [
          'Cleaning professionals assigned to your service',
  ...
  terms: {
    ...
    lastUpdated: 'Last updated',
    intro: 'By using UKLID PLUS PRAHA services, you agree to these terms.',
    sections: {
      services: {
        title: '1. Services',
        content: 'We provide professional cleaning services in Prague and surrounding areas. Service details are agreed upon booking.',
      },
      booking: {
        title: '2. Booking & Cancellation',
        content: 'Bookings can be made via WhatsApp, phone, or our contact form. Cancellation policy:',
        items: [
      ...
      payment: {
        title: '3. Payment',
        content: 'Payment is due upon service completion. We accept cash, bank transfer, and card payment.',
      },
      liability: {
        title: '4. Liability',
        content: 'We are insured against damage caused during cleaning. Report any issues within 24 hours.',
      },
      satisfaction: {
        title: '5. Satisfaction Guarantee',
        content: 'If you are not satisfied with our service, contact us within 24 hours for a free re-clean.',
      },
      changes: {
        title: '6. Changes to Terms',
        content: 'We reserve the right to update these terms. Continued use of services constitutes acceptance.',
      },
      contact: {
        title: '7. Contact',
