...
- Name: i18n.spec.ts >> i18n Language Selector >> should show language options when clicked
- Location: tests\e2e\i18n.spec.ts:32:3
...
Locator: locator('[role="menu"]').or(locator('[data-testid="language-dropdown"]'))
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[role="menu"]').or(locator('[data-testid="language-dropdown"]'))
...
- banner:
  - navigation "Main navigation":
    ...
    - link "Contact":
      - /url: /#contact
    - button "Select language" [expanded]: EN
    - listbox "Language options":
      - option "English" [selected]: EN
      - option "Čeština": CZ
      - option "Русский": RU
      - option "Українська": UA
    - link "Book Now":
      - /url: "#contact"
- main:
